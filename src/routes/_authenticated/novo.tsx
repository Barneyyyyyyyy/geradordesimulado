...
const PRESETS_UNICA: Preset[] = [
  ...
  { key: "filosofia", label: "Filosofia", emoji: "🤔", area: "humanas", materia: "Filosofia seguindo os capítulos do livro didático: experiência filosófica; origens da filosofia e pré-socráticos; natureza e cultura; linguagem e pensamento; trabalho, alienação e consumo; busca da felicidade; teoria do conhecimento; ideologias; lógica e falácias; Sócrates, Platão e Aristóteles; metafísica da modernidade (Descartes, Kant, Hegel, Marx); crise da razão (Husserl, Escola de Frankfurt, Foucault, pós-modernidade); moral e ética; Piaget e Kohlberg; liberdade e determinismo; teorias éticas; filosofia política; direitos humanos; Maquiavel, Hobbes, Locke e Rousseau; teorias socialistas; liberalismo; filosofia das ciências; estética e arte. Não fuja desses temas." },
...
const MATERIAS: Record<Area, string[]> = {
  ...
  humanas: [
    ...
    "Filosofia - A experiência filosófica",
    "Filosofia - As origens da filosofia (pré-socráticos)",
    "Filosofia - Natureza e cultura",
    "Filosofia - Linguagem e pensamento",
    "Filosofia - Trabalho, alienação e consumo",
    "Filosofia - Em busca da felicidade",
    "Filosofia - O que podemos conhecer? (teoria do conhecimento)",
    "Filosofia - Ideologias",
    "Filosofia - A lógica e as falácias",
    "Filosofia - A busca da verdade (Sócrates, Platão, Aristóteles)",
    "Filosofia - A metafísica da modernidade (Descartes, Kant, Hegel, Marx)",
    "Filosofia - A crise da razão (Husserl, Frankfurt, Foucault, pós-modernidade)",
    "Filosofia - Entre o bem e o mal (moral e ética)",
    "Filosofia - Ninguém nasce moral (Piaget e Kohlberg)",
    "Filosofia - Podemos ser livres? (liberdade e determinismo)",
    "Filosofia - Teorias éticas",
    "Filosofia - Política: para quê?",
    "Filosofia - Direitos humanos",
    "Filosofia - A política normativa (Platão e Aristóteles)",
    "Filosofia - A autonomia da política (Maquiavel, Hobbes, Locke, Rousseau)",
    "Filosofia - As teorias socialistas",
    "Filosofia - O liberalismo",
    "Filosofia - Ciência, tecnologia e valores",
    "Filosofia - Ciência antiga e medieval",
    "Filosofia - A revolução científica",
    "Filosofia - O método das ciências humanas",
    "Filosofia - Estética: introdução conceitual",
    "Filosofia - Cultura e arte",
    "Filosofia - Arte como forma de pensamento",
    "Filosofia - A significação na arte",
    "Filosofia - Concepções estéticas",
